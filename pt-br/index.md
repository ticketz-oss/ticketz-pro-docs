...
4. Consulte [Ticketz Sidekick]({{ '/pt-br/sidekick/' | relative_url }}) para backup, restore e migração de dados.
...
7. Veja [Server Cluster (not-released)]({{ '/pt-br/server-cluster/' | relative_url }}) para configuração de cluster e roteamento de login entre nós.
...
<div class="card-grid">
  ...
  <section class="info-card">
    <h3><a href="{{ '/pt-br/webchat/' | relative_url }}">Webchat</a></h3>
    <p>Configure o widget flutuante, personalize cores e publique no seu site.</p>
  </section>
  <section class="info-card">
  ...
  <section class="info-card">
    <h3><a href="{{ '/pt-br/expansion-variables/' | relative_url }}">Variáveis de expansão</a></h3>
    <p>Veja os placeholders disponíveis em templates, mensagens e automações.</p>
  </section>
  <section class="info-card">
  ...
  <section class="info-card">
    <h3><a href="{{ '/pt-br/server-cluster/' | relative_url }}">Server Cluster (not-released)</a></h3>
    <p>Configure papéis master/slave, regras de hostname e descoberta de login em múltiplos nós.</p>
  </section>
  <section class="info-card">
    <h3><a href="{{ '/pt-br/sidekick/' | relative_url }}">Ticketz Sidekick</a></h3>
    <p>Faça backup e restore do ambiente e importe dados de projetos derivados do Whaticket.</p>
  </section>
  <section class="info-card">
